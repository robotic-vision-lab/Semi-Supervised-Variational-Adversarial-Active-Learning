...
from train_test_sodeep_tests import train, test
from load_dataset import load_dataset
from selection_methods_tests import query_samples
from config import *
...
parser.add_argument("-wp", "--weight_path", type=str, default='./data', help='Path to where the weight of ranking model is')
...
if __name__ == '__main__':
    ...
    '''
    results = open(
        'results_' + str(args.method_type) + "_" + "sodeep_" + args.dataset + '_main' + str(args.cycles) + str(args.total) + '.txt',
        'w')
